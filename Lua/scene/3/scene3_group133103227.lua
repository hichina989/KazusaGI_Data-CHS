...
-- 装置
gadgets = {
	{ config_id = 227001, gadget_id = 70710006, pos = { x = 717.6, y = 320.1, z = 1520.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 24, persistent = true },
	{ config_id = 227002, gadget_id = 70710010, pos = { x = 668.2, y = 298.0, z = 1425.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 24, route_id = 310300076 },
	{ config_id = 227003, gadget_id = 70710007, pos = { x = 718.3, y = 320.2, z = 1519.0 }, rot = { x = 0.0, y = 218.8, z = 0.0 }, level = 24 },
	{ config_id = 227004, gadget_id = 70211111, pos = { x = 717.5, y = 320.0, z = 1521.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 24, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 227007, shape = RegionShape.SPHERE, radius = 5, pos = { x = 668.2, y = 298.0, z = 1425.3 } }
}
