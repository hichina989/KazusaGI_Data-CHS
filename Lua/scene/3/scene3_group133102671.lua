...
-- 装置
gadgets = {
	{ config_id = 671001, gadget_id = 70710006, pos = { x = 1782.1, y = 237.8, z = 463.4 }, rot = { x = 0.0, y = 69.2, z = 0.0 }, level = 18 },
	{ config_id = 671002, gadget_id = 70710010, pos = { x = 1812.1, y = 219.6, z = 523.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 18, route_id = 310200224 },
	{ config_id = 671003, gadget_id = 70710007, pos = { x = 1783.3, y = 238.1, z = 464.9 }, rot = { x = 0.0, y = 27.9, z = 0.0 }, level = 18 },
	{ config_id = 671004, gadget_id = 70211111, pos = { x = 1784.5, y = 237.9, z = 461.4 }, rot = { x = 354.0, y = 23.2, z = 1.7 }, level = 18, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 671007, shape = RegionShape.SPHERE, radius = 3, pos = { x = 1812.1, y = 219.5, z = 523.1 } }
}

-- 触发器
triggers = {
	{ name = "PLATFORM_REACH_POINT_671005", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_671005", action = "action_EVENT_PLATFORM_REACH_POINT_671005", trigger_count = 0 },
	{ name = "AVATAR_NEAR_PLATFORM_671006", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_671006", action = "action_EVENT_AVATAR_NEAR_PLATFORM_671006", trigger_count = 0 },
	{ name = "ENTER_REGION_671007", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_671007", action = "action_EVENT_ENTER_REGION_671007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_671008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_671008", action = "action_EVENT_GADGET_STATE_CHANGE_671008" },
	{ name = "GADGET_CREATE_671009", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_671009", action = "action_EVENT_GADGET_CREATE_671009", trigger_count = 0 }
}
