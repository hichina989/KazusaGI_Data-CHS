...
-- 装置
gadgets = {
	{ config_id = 191001, gadget_id = 70710006, pos = { x = 2264.7, y = 202.7, z = -500.0 }, rot = { x = 0.0, y = 106.3, z = 0.0 }, level = 15 },
	{ config_id = 191002, gadget_id = 70710010, pos = { x = 2503.2, y = 216.3, z = -432.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 2, route_id = 300400602 },
	{ config_id = 191003, gadget_id = 70710007, pos = { x = 2265.5, y = 202.7, z = -500.1 }, rot = { x = 0.0, y = 91.9, z = 0.0 }, level = 15 },
	{ config_id = 191004, gadget_id = 70211111, pos = { x = 2261.2, y = 202.7, z = -502.4 }, rot = { x = 0.0, y = 127.5, z = 0.0 }, level = 15, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 191007, shape = RegionShape.SPHERE, radius = 2, pos = { x = 2503.2, y = 216.4, z = -432.9 } }
}
