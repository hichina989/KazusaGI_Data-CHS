...
-- 装置
gadgets = {
	{ config_id = 50001, gadget_id = 70710006, pos = { x = 1216.9, y = 273.5, z = 1421.9 }, rot = { x = 0.0, y = 270.3, z = 0.0 }, level = 24, persistent = true },
	{ config_id = 50002, gadget_id = 70710010, pos = { x = 1258.1, y = 265.0, z = 1390.1 }, rot = { x = 357.3, y = 359.8, z = 8.0 }, level = 24, route_id = 310100064 },
	{ config_id = 50003, gadget_id = 70710007, pos = { x = 1218.3, y = 272.5, z = 1419.5 }, rot = { x = 0.0, y = 129.9, z = 0.0 }, level = 24 },
	{ config_id = 50004, gadget_id = 70211111, pos = { x = 1217.0, y = 273.5, z = 1423.2 }, rot = { x = 0.0, y = 272.9, z = 0.0 }, level = 24, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 50007, shape = RegionShape.SPHERE, radius = 5, pos = { x = 1257.3, y = 264.9, z = 1390.5 } }
}
