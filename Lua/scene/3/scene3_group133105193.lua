...
-- 装置
gadgets = {
	{ config_id = 193001, gadget_id = 70710006, pos = { x = 766.8, y = 271.6, z = -122.3 }, rot = { x = 0.0, y = 181.2, z = 0.0 }, level = 25, persistent = true },
	{ config_id = 193002, gadget_id = 70710010, pos = { x = 733.5, y = 256.1, z = -155.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 25, route_id = 310500053 },
	{ config_id = 193003, gadget_id = 70710007, pos = { x = 766.6, y = 271.8, z = -122.6 }, rot = { x = 0.0, y = 228.5, z = 0.0 }, level = 25 },
	{ config_id = 193004, gadget_id = 70211111, pos = { x = 766.7, y = 271.9, z = -123.9 }, rot = { x = 5.8, y = 181.3, z = 2.7 }, level = 25, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 193007, shape = RegionShape.SPHERE, radius = 3.7, pos = { x = 735.0, y = 256.9, z = -155.3 } }
}

-- 触发器
triggers = {
	{ name = "PLATFORM_REACH_POINT_193005", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_193005", action = "action_EVENT_PLATFORM_REACH_POINT_193005", trigger_count = 0 },
	{ name = "AVATAR_NEAR_PLATFORM_193006", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_193006", action = "action_EVENT_AVATAR_NEAR_PLATFORM_193006", trigger_count = 0 },
	{ name = "ENTER_REGION_193007", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_193007", action = "action_EVENT_ENTER_REGION_193007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_193008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_193008", action = "action_EVENT_GADGET_STATE_CHANGE_193008" },
	{ name = "GADGET_CREATE_193009", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_193009", action = "action_EVENT_GADGET_CREATE_193009", trigger_count = 0 }
}
