...
-- 装置
gadgets = {
	{ config_id = 252001, gadget_id = 70710006, pos = { x = -177.3, y = 157.9, z = 954.2 }, rot = { x = 0.0, y = 149.7, z = 0.0 }, level = 32 },
	{ config_id = 252002, gadget_id = 70710010, pos = { x = -169.9, y = 164.4, z = 1008.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 32, route_id = 310600096 },
	{ config_id = 252003, gadget_id = 70710007, pos = { x = -177.2, y = 158.3, z = 955.7 }, rot = { x = 0.0, y = 12.9, z = 0.0 }, level = 32 },
	{ config_id = 252004, gadget_id = 70211111, pos = { x = -178.7, y = 158.0, z = 954.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 32, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 252007, shape = RegionShape.SPHERE, radius = 3, pos = { x = -170.0, y = 163.6, z = 1010.4 } }
}

-- 触发器
triggers = {
	{ name = "PLATFORM_REACH_POINT_252005", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_252005", action = "action_EVENT_PLATFORM_REACH_POINT_252005", trigger_count = 0 },
	{ name = "AVATAR_NEAR_PLATFORM_252006", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_252006", action = "action_EVENT_AVATAR_NEAR_PLATFORM_252006", trigger_count = 0 },
	{ name = "ENTER_REGION_252007", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_252007", action = "action_EVENT_ENTER_REGION_252007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_252008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_252008", action = "action_EVENT_GADGET_STATE_CHANGE_252008" },
	{ name = "GADGET_CREATE_252009", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_252009", action = "action_EVENT_GADGET_CREATE_252009", trigger_count = 0 }
}
