...
-- 装置
gadgets = {
	{ config_id = 381001, gadget_id = 70710006, pos = { x = 2600.9, y = 221.7, z = -1500.4 }, rot = { x = 0.0, y = 334.9, z = 0.0 }, level = 2 },
	{ config_id = 381002, gadget_id = 70710010, pos = { x = 2604.1, y = 212.6, z = -1402.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 2, route_id = 300300269 },
	{ config_id = 381003, gadget_id = 70710007, pos = { x = 2600.9, y = 222.2, z = -1500.2 }, rot = { x = 0.0, y = 356.5, z = 0.0 }, level = 2 },
	{ config_id = 381004, gadget_id = 70211111, pos = { x = 2600.4, y = 220.6, z = -1498.8 }, rot = { x = 0.0, y = 338.5, z = 0.0 }, level = 2, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 381007, shape = RegionShape.SPHERE, radius = 4, pos = { x = 2604.2, y = 212.6, z = -1401.8 } }
}

-- 触发器
triggers = {
	{ name = "PLATFORM_REACH_POINT_381005", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_381005", action = "action_EVENT_PLATFORM_REACH_POINT_381005", trigger_count = 0 },
	{ name = "AVATAR_NEAR_PLATFORM_381006", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_381006", action = "action_EVENT_AVATAR_NEAR_PLATFORM_381006", trigger_count = 0 },
	{ name = "ENTER_REGION_381007", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_381007", action = "action_EVENT_ENTER_REGION_381007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_381008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_381008", action = "action_EVENT_GADGET_STATE_CHANGE_381008" },
	{ name = "GADGET_CREATE_381009", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_381009", action = "action_EVENT_GADGET_CREATE_381009", trigger_count = 0 }
}
