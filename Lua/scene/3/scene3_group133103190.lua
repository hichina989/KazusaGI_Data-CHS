...
-- 装置
gadgets = {
	{ config_id = 190001, gadget_id = 70710006, pos = { x = 847.4, y = 353.6, z = 1764.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 24, persistent = true },
	{ config_id = 190002, gadget_id = 70710010, pos = { x = 938.8, y = 385.8, z = 1582.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 24, route_id = 310300061 },
	{ config_id = 190003, gadget_id = 70710007, pos = { x = 848.8, y = 354.2, z = 1762.4 }, rot = { x = 0.0, y = 147.0, z = 0.0 }, level = 24 },
	{ config_id = 190004, gadget_id = 70211111, pos = { x = 846.7, y = 353.0, z = 1763.3 }, rot = { x = 355.1, y = 33.4, z = 358.7 }, level = 24, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 190007, shape = RegionShape.SPHERE, radius = 3, pos = { x = 938.9, y = 384.4, z = 1582.5 } }
}
