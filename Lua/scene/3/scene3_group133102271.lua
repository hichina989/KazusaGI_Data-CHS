...
-- 装置
gadgets = {
	{ config_id = 271001, gadget_id = 70710006, pos = { x = 1068.4, y = 201.1, z = 235.8 }, rot = { x = 358.5, y = 92.7, z = 2.1 }, level = 32, persistent = true },
	{ config_id = 271002, gadget_id = 70710010, pos = { x = 1119.3, y = 201.7, z = 240.7 }, rot = { x = 0.0, y = 222.2, z = 0.0 }, level = 32, route_id = 310200109 },
	{ config_id = 271003, gadget_id = 70710007, pos = { x = 1069.1, y = 201.0, z = 236.1 }, rot = { x = 0.0, y = 75.1, z = 0.0 }, level = 32 },
	{ config_id = 271004, gadget_id = 70211111, pos = { x = 1065.2, y = 200.3, z = 233.5 }, rot = { x = 8.4, y = 47.2, z = 354.7 }, level = 16, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 271007, shape = RegionShape.SPHERE, radius = 3, pos = { x = 1119.8, y = 201.5, z = 240.8 } }
}
