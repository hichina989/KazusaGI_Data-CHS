...
-- 装置
gadgets = {
	{ config_id = 203001, gadget_id = 70710006, pos = { x = 2518.0, y = 211.0, z = 330.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 23 },
	{ config_id = 203002, gadget_id = 70710010, pos = { x = 2548.6, y = 219.6, z = 370.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 23, route_id = 300700119 },
	{ config_id = 203003, gadget_id = 70710007, pos = { x = 2519.3, y = 211.3, z = 332.2 }, rot = { x = 351.1, y = 30.4, z = 352.3 }, level = 23 },
	{ config_id = 203004, gadget_id = 70211111, pos = { x = 2520.3, y = 210.7, z = 329.2 }, rot = { x = 349.6, y = 0.2, z = 357.8 }, level = 23, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 203007, shape = RegionShape.SPHERE, radius = 3, pos = { x = 2548.0, y = 219.6, z = 370.0 } }
}
