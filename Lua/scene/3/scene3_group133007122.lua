...
-- 装置
gadgets = {
	{ config_id = 122001, gadget_id = 70710006, pos = { x = 2788.9, y = 206.8, z = 37.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 23 },
	{ config_id = 122002, gadget_id = 70710010, pos = { x = 2749.6, y = 210.4, z = 46.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 23, route_id = 300700131 },
	{ config_id = 122003, gadget_id = 70710007, pos = { x = 2788.7, y = 206.8, z = 38.3 }, rot = { x = 0.0, y = 287.4, z = 0.0 }, level = 23 },
	{ config_id = 122004, gadget_id = 70211111, pos = { x = 2790.4, y = 206.8, z = 38.7 }, rot = { x = 0.0, y = 0.0, z = 1.8 }, level = 23, drop_tag = "解谜中级蒙德", showcutscene = true, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 122007, shape = RegionShape.SPHERE, radius = 3, pos = { x = 2749.6, y = 210.4, z = 46.9 } }
}

-- 触发器
triggers = {
	{ name = "PLATFORM_REACH_POINT_122005", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_122005", action = "action_EVENT_PLATFORM_REACH_POINT_122005", trigger_count = 0 },
	{ name = "AVATAR_NEAR_PLATFORM_122006", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_122006", action = "action_EVENT_AVATAR_NEAR_PLATFORM_122006", trigger_count = 0 },
	{ name = "ENTER_REGION_122007", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_122007", action = "action_EVENT_ENTER_REGION_122007", trigger_count = 0 },
	{ name = "GADGET_STATE_CHANGE_122008", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_122008", action = "action_EVENT_GADGET_STATE_CHANGE_122008" },
	{ name = "GADGET_CREATE_122009", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_122009", action = "action_EVENT_GADGET_CREATE_122009", trigger_count = 0 }
}
